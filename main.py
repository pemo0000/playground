...
parser.add_argument("-p", "--piece",
                    help="Chess piece you want to put on a square. Options are [K]ing, [Q]ueen, [R]ook and [B]ishop.",
                    choices=["K", "Q", "R", "B"], default="Q")
...
horizontalSquares, verticalSquares, diagonalSquares, legalKingSquares = board1.horizontal_squares(x, y), board1.vertical_squares(x, y), board1.diagonal_squares(x, y), board1.king_squares(x, y)
board1.put_piece(piece, x, y)
board1.set_squares(piece, horizontalSquares, verticalSquares, diagonalSquares, legalKingSquares)
board1.print()
