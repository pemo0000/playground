...
parser.add_argument("-p", "--piece",
                    help="Chess piece you want to put on a square. Options are [Q]ueen, [R]ook and [B]ishop.",
                    choices=["Q", "R", "B"], default="Q")
...
horizontalSquares = board1.horizontal_squares(x, y)
verticalSquares = board1.vertical_squares(x, y)
diagonalSquares = board1.diagonal_squares(x, y)
board1.put_piece(piece, x, y)
board1.set_squares(piece, horizontalSquares, verticalSquares, diagonalSquares)
board1.print()
